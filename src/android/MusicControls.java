...
public class MusicControls {
	...
	public MusicControls(CordovaInterface cordova, AudioHandler handler) {
	...
	public void create(final JSONArray args) throws JSONException{
	...
	public void updateCover(String coverURL) {
		this.notification.updateCover(coverURL);
	}
	...
	private void setMediaPlaybackState(int state) {
		try {
            ...
            LOG.e("MusicControls ERROR: ", "setMediaPlaybackState ", e);
